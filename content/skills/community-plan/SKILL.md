...
1. **Where it sits in the funnel.** What is it supposed to convert, and from what to what? "Engagement" is not an answer.
2. **The stages.** B2C: superfans → ambassadors → organic growth. B2B: champions → advisors → references → pipeline. Define what moves someone between them.
3. **The first ten people.** Named. Real. What you'll ask each of them to do.
