...
1. Pull whatever numbers exist — analytics, dashboard, or the user's best estimate. Estimates are fine; label them as estimates.
2. Compute stage-to-stage conversion. Compare each against a rough benchmark for their category and say where the benchmark comes from.
