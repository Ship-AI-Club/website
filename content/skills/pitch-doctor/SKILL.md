...
2. **Who it's for** — narrow, straight from the brief.
3. **What it does** — the one-liner, delivered rather than recited.
4. **Why you** — the sharp edge plus any proof. A number beats an adjective every time.
5. **The ask** — specific to this listener. Write at least two versions: one for a customer, one for an investor. The ask is the beat people skip, and it's the only one that does anything.
