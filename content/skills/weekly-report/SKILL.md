...
3. **The format: under 200 words.** Each number, the change from last week, the single biggest mover, and one line on what you'd do about it. No charts. No preamble. No restating the numbers in a summary paragraph.
...
6. **Be honest about small numbers.** Below roughly twenty events in the window, report absolute counts only and say in the report why. "+200%" off one extra signup is noise wearing a suit, and reporting it is how a founder's numbers stop being trusted.
