/* ------------------------------------------------------------------
   ...
   /hackathon ("What you leave with") plus the reasons people show up
...
export const REQUESTABLE_ROLES = ["sponsor", "mentor", "judge"];
...
/* The six deliverables, verbatim from the "What you leave with"
   section of /hackathon. If that section changes, change these with
...
export const COMMUNITY_GOALS = [
  ...
  { id: "hire", label: "Hire — or get hired" },
...
/* The four tiers as onboarding offers them, plus the two answers the
   ...
   figure someone picks here is the figure on /hackathon/sponsor —
...
/* The four published criteria and their weights, matching the "How
   it's scored" block on /hackathon exactly. `key` is the column name
