...
export const DECKS = {
  "gtm-engineering": [
    { kind: "title", ascii: ASCII_GTM, sub: "Go-to-market engineering, end to end" },
    {
      kind: "agenda",
      title: "Tonight",
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { t: "Mathematicians report a “very rapid, very unsettling change”", c: "Longstanding open problems are falling to AI, faster than the field can referee." },
        { t: "Markets can't make up their mind", c: "S&P record high then a plunge, same day. AI capex is the argument on both sides." },
      ],
    ...
    {
      kind: "timeline",
      title: "Tonight is session one of six",
      note: "Six Wednesdays, then the October 16–18 hackathon weekend. Every session is free and standalone — tonight is the map, and everything after it hangs off it.",
    },
    { kind: "act", n: "03", eyebrow: "The map", title: "The three acts", c: "Every go-to-market motion is one of three jobs. Doing them out of order is the most common way a good product stays invisible." },
    {
      kind: "walk",
      ...
      note: "The order is the point. Doing these out of order is the most common way a good product stays invisible.",
    },
    {
      kind: "statement",
    ...
    { kind: "act", n: "04", eyebrow: "The model", title: "Model the funnel", c: "Not the six stages from a template. The four you can actually put a number against this week." },
    {
      kind: "funnel",
    ...
    {
      kind: "loop",
      title: "Not one-off manual work — a system that engineers growth",
      ...
      label: "Weekly",
      note: "Repeatable — the same four steps every week. Scalable — code runs it, not headcount. Dynamic — every pass changes what ships next. Marketing runs this loop on creative; growth engineering runs it on code. You'll do both before October.",
    },
    {
      kind: "matrix",
      title: "The fork: B2C and B2B, side by side",
      heads: ["B2C", "B2B"],
      rows: [
    ...
    },
    {
      ...
      note: "Write these five once and they become your hero, your cold email, your ad and your pitch. Skip them and you write all four separately, and they disagree. September 16 is a whole session on this line alone.",
    },
    { kind: "act", n: "05", eyebrow: "The systems", title: "What it looks like in production", art: "bolt", c: "Not theory — running systems. Three shapes you'll see everywhere, the toolkit behind them, and the numbers that tell you whether they're working." },
    {
      kind: "walk",
    ...
    {
      kind: "walk",
      title: "System three: the brand as a build artifact",
      steps: [
        {
          t: "Tokens",
          c: "colour, type, spacing — in code",
          d: "One file the whole surface reads from: palette, type scale, spacing, the wordmark. Not a Figma page someone copies from by hand — a file an agent imports. Decide it in an hour on day one and never decide it again.",
        },
        {
          t: "Components",
          c: "the same ten pieces everywhere",
          d: "Buttons, cards, tables, section headers. The site, the deck and the one-pager render from the same components, so consistency stops being discipline and becomes a dependency.",
        },
        {
          t: "Generator",
          c: "collateral from data, not from Keynote",
          d: "Decks, one-pagers, case studies, OG images — generated from structured content. These slides are an array in a repo, rendered by the same design system as the site. No export step; a typo is a one-line commit.",
        },
        {
          t: "Every surface",
          c: "site, deck, email, README, invoice",
      ...
      note: "A design system on day one is the cheapest decision in the program. It costs an hour, and every artifact after it is free.",
    },
    {
      kind: "statement",
      text: "Polish takes you from looking like a 4 to a 9.",
      note: "Same product, same features, same founder. The delta is consistency applied to every surface — and consistency is a build step now, not a hire. Your product isn't behind the brand. It is the brand.",
    },
    {
      kind: "matrix",
    ...
    },
    {
      ...
      items: [
        ...
        { v: "6 mo", l: "CAC payback, or the channel's broken" },
        { v: "40%", l: "D1 retention floor — below it, fix onboarding" },
      ],
    ...
    {
      kind: "matrix",
      title: "What each session hands the next",
      heads: ["You leave with", "It feeds"],
      rows: [
        { t: "01 · tonight", cells: ["A funnel you can measure", "Everything. It's the map."] },
        { t: "02 · Aug 19", cells: ["A channel plan, funnel instrumented", "The paid ceiling in 06"] },
        { t: "03 · Sep 2", cells: ["Twenty named accounts", "The sequence you send in October"] },
        { t: "04 · Sep 16", cells: ["Positioning brief and pitch", { v: "The hero, the bio, the ad, the pitch", lit: true }] },
        { t: "05 · Oct 7", cells: ["A deployed site, profiles fixed", "What every channel points at"] },
        { t: "06 · Oct 14", cells: ["Content automation, a CAC ceiling", "The weekend"] },
      ],
      note: "Six deliverables, each one the input to the next. Missing a session isn't fatal — every step is in the repo — but the chain is why the order is the order.",
    },
    {
      kind: "flow",
