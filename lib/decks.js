  ...
  "b2c-ggbucks-case-study": [
    ...
    },
    {
      ...
      rows: [
        ...
        { t: "Apple Search Ads", cells: ["$21", "0", "—"] },
      ],
      note: "One of these worked. TikTok cost ten times Google per install and was killed on day six. iOS has taken $57 across ASA and the App campaign and returned no attributed installs at all. Four channels, and the honest answer is that the business runs on one of them.",
    },
    {
      kind: "bullets",
      cols: 2,
