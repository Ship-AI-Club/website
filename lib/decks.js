...
export const DECKS = {
  ...
  "b2c-ggbucks-case-study": [
    ...
    HOST_SLIDE,
    {
      ...
      title: "Tonight",
      items: [
        "The brief — four stories, then a five-minute break",
    ...
    },
    {
      ...
      note: "Five steps, no approval gate anywhere in them. That's the whole design, and it's why it produced 783 posts. Postiz ran it from January to Jul 22, then I moved publishing direct into our own social service, and I'm moving it again now to Zernio. Three publishers in seven months — the plumbing was never the hard part.",
    },
    {
      kind: "gallery",
    ...
    },
    {
      ...
      note: "Four weekly cohorts, day one to day seven. Aug 3 is the most recent one whose whole D7 window has closed — that's the honest read. Aug 10 is dashed because it's still inside its own window and will move. Every curve bends the same way; the only question is how high it starts and how fast it falls. This is the number to work on before you spend, because paid doesn't fix retention — it buys more people to leak. Whatever your D7 is tonight, that's the ceiling you're buying against.",
    },
    {
      kind: "statement",
    ...
    /* ---- the presentation — from this business to yours ---- */
    ...
    },
    {
      ...
      c: "Everything tonight is acquisition: get them to the door. Growth Loops is the other half — measure the value event, shorten the path to first value, read cohorts properly, and turn one proven behaviour into a loop. Six sessions, dates landing soon. If your D30 looks like mine, that's the one to be in the room for.",
    },
    ...
    /* ---- questions, then the close ---- */
    {
      ...
      note: "The dashboard is open and nothing is off the table — spend, retention, the appeal, the parts I got wrong. If you'd rather ask it one to one, grab me on the way out.",
    },
    {
      kind: "thanks",
