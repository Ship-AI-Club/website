...
export const DECKS = {
  "gtm-engineering": [
    ...
    },
    {
      ...
      orgs: [
        { name: "Workuity", img: "/sponsor-workuity.png", tag: "Platinum · The venue" },
        { name: "CEI Gateway", img: "/sponsor-cei.png", tag: "Silver · The venue" },
        { name: "Venture Café Phoenix", img: "/sponsor-venturecafe.png", tag: "Community", wide: true },
      ],
      note: "The rooms, the nights, the coffee — these three keep Ship AI free. Thank them by using it.",
    },
    {
      kind: "end",
      eyebrow: "Sponsors",
