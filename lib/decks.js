...
export const DECKS = {
  ...
  "b2c-ggbucks-case-study": [
    ...
    },
    {
      ...
      note: "Aug 11–17: $7,424 of revenue on $426 of spend — blended, not paid-cohort, and 68% of this month's installs were unpaid. The first paid dollar wasn't spent until July 14; the product had already done $4,949 before it. The ratio is the point: paid is a small input into a machine that mostly runs without it.",
    },
    {
      kind: "agenda",
      title: "Tonight",
    ...
    { kind: "act", n: "03", eyebrow: "Act three", title: "Receipts", art: "dome", c: "Thirty percent of the October score. \"We didn't really track that\" is the most common way a good ship weekend loses." },
    {
      ...
      note: "Wiring an event and never watching it fire is how you get eight weeks of empty charts. Take a baseline today, with today's date — in eight weeks it's the \"before\" half of the story you take to October.",
    },
    {
      kind: "terminal",
      cmd: "/channel-plan",
