...
export const DECKS = {
  ...
  "b2c-ggbucks-case-study": [
    ...
    },
    {
      ...
      note: "Nice images, advertising no product in particular. 502 posts on Facebook, 281 on Instagram, and late-era engagement rounds to zero. The model was never the bottleneck.",
    },
    {
      kind: "matrix",
    ...
    { kind: "act", n: "04", eyebrow: "The compounding half", title: "Community and retention", art: "mark", c: "Paid stops the day you stop paying. This doesn't. Neither does a leak." },
    {
      ...
      note: "It's a stage with a conversion rate, not a Discord you open and hope. Ours: 51 referrals started, 5 completed, no ambassador programme yet.",
    },
    {
      kind: "cohorts",
    ...
    },
    {
      ...
      note: "Google does the volume. TikTok cost ten times as much per install and was killed on day six. Apple Search Ads reports zero installs here, and the next slide disagrees.",
    },
    {
      kind: "bullets",
      cols: 2,
      ...
      items: [
        ...
        { t: "Monitoring that wasn't", c: "The scheduled reports only ran while a desktop app happened to be open. Automation you don't verify is a cron job you imagined." },
      ],
    },
    ...
    },
    {
      ...
      c: "Workuity hosts and sponsors every meetup in this series, tonight included. Say thanks on your way out.",
      img: "/sponsor-workuity.png",
    ...
    },
    {
      ...
      qr: "sponsors",
      qrLabel: "The menu — shipai.club",
      c: "This is how the next five stay free. Published tiers from $1,000 to $10,000, in cash, credits or hours. Grab Santos before you leave.",
    },
    {
      kind: "contact",
      title: "Say hi",
