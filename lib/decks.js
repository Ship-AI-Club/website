...
const ABOUT_SLIDE = {
  ...
  text: "Demos over memos.",
  tags: ["Builders & founders", "Phoenix & Tempe", "Free, always"],
  note: "Ship AI is a free, community-run AI education project. The premise is simple: the best AI education isn't behind a paywall or on a stage — it's builders showing each other the work, in the open, for free.",
};
...
export const DECKS = {
  "gtm-engineering": [
    ...
    },
    {
      ...
      left: {
        ...
        items: [
          ...
          "\"AI-powered\" is the whole pitch and there's no build behind it",
        ],
      },
      right: {
    ...
    },
    {
      ...
      note: "Six workshops, then the October 16–18 weekend. Tonight connects the dots — the whole go-to-market system in one pass — and every piece gets a full session of its own between now and October. Catch the shape now; collect the specifics as we go.",
    },
    ...
    { kind: "act", n: "05", eyebrow: "The systems", title: "What it looks like in production", art: "bolt", c: "Not theory — running systems. The day-one stack, three shapes you'll see everywhere, the toolkit behind them, and the numbers that tell you whether they're working." },
    {
      kind: "bullets",
