...
export const DECKS = {
  ...
  "b2c-ggbucks-case-study": [
    ...
    },
    {
      ...
      v: "$3,318",
      delta: "$0 ad spend",
      c: "Feb 7 to Mar 8, 2026 — the first thirty days after it shipped, straight off the dashboard. Not a dollar of it was bought: the first paid dollar wasn't spent until June 15.",
    },
    {
      kind: "chart",
    ...
    },
    {
      ...
      points: [
        ...
        { l: "Jul", v: 2219 },
        { l: "Aug 17", v: 15479 },
        { l: "EOM", v: 30326, proj: true },
      ],
      peak: "$15,479",
      note: "Monthly revenue, same dashboard. Solid is banked: $15,479 through Aug 17. The dashed leg is a forecast, not a reading — $30,326 if the trailing 7-day average of $1,060/day holds to the 31st, and it might not. Look at what the scale does to the rest: February, the spike that felt like the business taking off, is a bump; the four months that felt like dying are a flat line near zero. May was $303.",
    },
    {
      kind: "curve",
    ...
    },
    {
      ...
      items: [
        { v: "$1,060", l: "revenue per day, 7-day average", lit: true },
        { v: "$61", l: "ad spend per day" },
        { v: "68%", l: "of this month's installs organic" },
      ],
      note: "Aug 11–17: $7,424 of revenue on $426 of spend. The first paid dollar wasn't spent until June 15 — by then the product had already done $4,538 on nothing. The ratio is the point: paid is a small input into a machine that mostly runs without it.",
    },
    {
      kind: "agenda",
      title: "Tonight",
    ...
    },
    {
      ...
      out: ["auditing 41 pages…", "12 fixes, 3 blocking", "240 pages from one template"],
      title: "The SEO half, mostly not typed by hand",
      c: "Off skills.sh — seo-audit, programmatic-seo, ai-seo and content-strategy, from coreyhaines31/marketingskills. Install them once and the mechanical half of ranking stops being a project. Which queries deserve a page at all is still your call, and it's the half that decides whether any of it works.",
    },
    {
      kind: "split",
      ...
      right: { h: "Distribution", items: ["Scheduled, not posted by hand", "Postiz today", "Moving to Zernio", "One pipeline, every channel"] },
    },
    {
      kind: "statement",
    ...
    },
    {
      ...
      steps: [
        ...
        {
          t: "The ceiling",
          c: "~$65/day, 14x blended",
          d: "August: $1,098 of spend against $15,479 of revenue. Spend sits around $65 a day because that's where the arithmetic still works — pushing it higher is session 06's problem. A channel isn't good or bad; the numbers under it are.",
        },
      ],
