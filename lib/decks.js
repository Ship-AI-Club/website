...
export const DECKS = {
  ...
  "b2c-ggbucks-case-study": [
    ...
    },
    {
      ...
      peak: "$15,504",
      note: "Monthly revenue, same dashboard, complete days only, as of Aug 17. Solid is banked: $15,504. The dashed leg is a forecast, not a reading — $30,401 if the trailing 7-day average of $1,064/day holds to the 31st, and it might not. Both partners backfill for days afterwards, so every number here moves slightly after I say it. Look at what the scale does to the rest: February, the spike that felt like the business taking off, is a bump; the four months that felt like dying are a flat line near zero. May was $303.",
    },
    {
      kind: "curve",
    ...
    {
      kind: "statement",
      text: "One table said the channel was dead. Another said it was the best one we had.",
      note: "Apple Search Ads: $21 spent. singular_campaign_stats reports 0 installs, because iOS install postbacks never populated that column. singular_attributions, same spend, shows 44 registrations, 13 first rewards and $407 of revenue events. Neither table is lying. One of them just isn't wired. If you take one thing from tonight, take this: a channel you cannot measure looks exactly like a channel that doesn't work, and you will kill it for the wrong reason.",
    },
