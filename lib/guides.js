...
import { DAY_ONE_GUIDES } from "./dayone-guides.js";
  ...
  const steps = SETUP.steps
    ...
    .map((s) =>
      s.t === OUTPUT_STEP && !program?.templateRepo
        ? {
            ...s,
            c: `The skills write markdown and don't care where it lands. A ${
...
export const GUIDES = {
  ...
  "growth-engineering": {
    ...
    output: "06-growth/ — unit-economics.md with the CAC ceiling, pricing.md, paid-basics.md, and social-automation.md with a week queued.",
    stuck:
...
export const GUIDES_BY_PROGRAM = { "zero-to-launch": GUIDES, "day-one": DAY_ONE_GUIDES };
