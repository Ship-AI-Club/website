/* ------------------------------------------------------------------
   ...
   Rendered at /hackathon/workshops/<slug>/guide, and written out as
...
export const GUIDES = {
  "gtm-engineering": {
    ...
    output: "01-roadmap/README.md — funnel, fork call, dated roadmap, three fixes.",
    stuck:
  ...
  "b2c-ggbucks-case-study": {
    ...
    steps: [
      ...
      {
        t: "Structure the first paid test",
        run: "/paid-test",
        c: "Only after the unit economics are clear. Small budget, one variable, a fixed end date.",
        good: "A test you could stop tomorrow without regret.",
      },
      {
    ...
    output: "02-b2c/README.md — channel plan, instrumented funnel, baseline snapshot, weekly report running.",
    stuck:
  ...
  "b2b-pipeline-sales": {
    ...
    output: "03-b2b/README.md — ICP, twenty accounts, outbound sequence, pilot structure, pipeline tracking.",
    stuck:
  ...
  "positioning-and-pitch": {
    ...
    output: "04-positioning/README.md — one-page brief, one-liner, both pitch versions.",
    stuck:
  ...
  "marketing-site": {
    ...
    output: "05-site/ — deployed URL, performance snapshot, content map, profiles fixed.",
    stuck:
  ...
  "growth-engineering": {
    ...
    steps: [
      ...
      },
      {
        ...
        run: "/paid-basics",
        c: "Account structure, creative angles versus variations, targeting narrow before broad, and the daily raise/hold/cut loop.",
    ...
    output: "06-growth/README.md — content automation running, pricing, paid plan, CAC ceiling.",
    stuck:
