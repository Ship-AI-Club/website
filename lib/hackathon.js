/* ------------------------------------------------------------------
   ...
   hackathon weekend lives here. /hackathon, /hackathon/workshops and
...
export const EVENT = {
  ...
  city: "Phoenix, AZ",
  // the hackathon weekend is at Workuity; workshops alternate — see VENUES
  venueKey: "workuity",
...
/* Ship AI alternates two venues, both community sponsors: the first
   Wednesday of the month at Workuity Biltmore, then two Wednesdays later
   at CEI Gateway. On Meetup/Luma the "⚡" title variant is Workuity and
   the ":" variant is CEI — that's how the rotation reads on the calendar. */
export const VENUES = {
  workuity: {
  ...
  cei: {
    name: "CEI Gateway",
    street: "275 N Gateway Dr",
    city: "Phoenix",
    region: "AZ",
    zip: "85034",
    address: "275 N Gateway Dr, Phoenix, AZ 85034",
    url: "https://www.ceigateway.com/",
    note: "Two Wednesdays after the Workuity session.",
  },
};
...
export const MAIL = "santos.d.hernandez@gmail.com";
export const SPONSOR_MAIL = `mailto:${MAIL}?subject=Sponsoring%20Zero%20to%20Launch`;
export const JUDGE_MAIL = `mailto:${MAIL}?subject=Judging%20Zero%20to%20Launch`;
export const MENTOR_MAIL = `mailto:${MAIL}?subject=Mentoring%20at%20Zero%20to%20Launch`;
...
export const WORKSHOPS = [
  {
    ...
    commit: "01-roadmap/README.md — if you want somewhere to put it: your funnel sketched out with the stages you can actually measure today, and a roadmap to a launch in October.",
    skills: ["gtm-map", "funnel-audit"],
  },
  {
    n: "02",
    ...
    act: "Vision",
    copy: "Santos walks his own launch as a live demo with the real numbers on screen: $0 to $3,000 in the first 30 days with zero paid ad spend, then scaling into paid at $100–200/day, profitably. Creative, targeting, what the unit economics had to look like first — and the parts that didn't work, in the same detail as the parts that did.",
    ...
    agenda: [
      { t: "$0 → $3,000 in 30 days, zero paid", c: "What the channels actually were, in what order, and how much of it was repeatable versus lucky." },
      { t: "The switch to paid", c: "What had to be true first. Why spending before the unit economics were clear would have killed it." },
      { t: "Scaling to $100–200/day, profitably", c: "Creative, targeting, the daily loop, and the numbers watched to decide whether to raise or cut spend." },
    ...
    commit: "02-b2c/README.md — afterward, if you want it: your own channel plan (first channel, test, budget, go/no-go number) plus an instrumented funnel and a baseline snapshot.",
  ...
  },
  {
    ...
    commit: "03-b2b/README.md — afterward, if you want it: twenty named accounts, an outbound sequence, the pilot structure you're offering, and how you're tracking the pipeline.",
  ...
  },
  {
    ...
    commit: "04-positioning/README.md — afterward, if you want it: your one-page brief plus both pitch versions, written out.",
  ...
  },
  {
    ...
    commit: "06-growth/README.md — afterward, if you want it: your content automation setup, your paid plan, and the CAC ceiling it has to clear.",
    skills: ["social-automation", "paid-basics", "paid-test", "unit-economics", "pricing-model"],
  },
