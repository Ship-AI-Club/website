...
/* Per-event RSVP link. The Meetup event URL doesn't exist until the event
   is created — until then this falls back to the group calendar. */
export function rsvpLinks(workshop) {
  return {
    meetup: workshop.meetup || MEETUP,
    pending: !workshop.meetup,
  };
}
...
export const WORKSHOPS = [
  ...
  },
  {
    ...
    agenda: [
      ...
      { t: "Scaling paid, profitably", c: "The first paid dollar wasn't spent until July 14, five months in. Creative, targeting, the daily loop, and the numbers watched to decide whether to raise or cut spend — currently about $65 a day against roughly $1,000 a day of revenue." },
