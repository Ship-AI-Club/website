...
import { DAY_ONE_SESSIONS, DAY_ONE_STEPS } from "./dayone.js";
...
export const PROGRAMS = [
  {
    ...
    description:
      "Six free go-to-market workshops in Phoenix, alternating between Workuity Biltmore and CEI Gateway, every other Wednesday from August 5 to October 14, 2026. B2C and B2B case studies, positioning, agentic analytics, marketing sites and pricing — leading into the Zero to Launch hackathon.",
  ...
  },
  {
    ...
    templateRepo: null,
    outputDir: "01-voice/",
    /* Where a Day One graduate goes next — the four sessions end at a
