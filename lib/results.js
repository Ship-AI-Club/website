/* ------------------------------------------------------------------
   ...
   Two promises on /programs/zero-to-launch/hackathon are backed by this file: every team that
...
export function certPath(e) {
  return `/programs/zero-to-launch/hackathon/certificate/${encodeURIComponent(e.id)}`;
}
