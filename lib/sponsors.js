/* ------------------------------------------------------------------
   ...
   all live here. /hackathon/sponsor renders the whole thing and the
   #sponsor section on /hackathon renders TIERS alone, so a price
...
export const MENU = [
  {
    id: "room",
    name: "The room",
    note: "Venues are held: Workuity Biltmore and CEI Gateway split the Wednesdays as in-kind partners, and Workuity hosts the weekend.",
    items: [
      {
        name: "Feed the room",
        price: 500,
...
/* Four steps, because the question every sponsor asks second is
   "what do you need from me". Step 3 is the /intake page — the URL is
   deliberately not published here, it gets sent once someone says yes. */
export const PROCESS = [
  ...
  {
    title: "We send you a private intake link",
    copy: "One form: company name, logo, a headshot and preferred title for whoever's being credited, and any brand assets or usage rules we should follow — up to a full 64 MB brand kit. It's the only asset request you'll get from us.",
  },
  {
